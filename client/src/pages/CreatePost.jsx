    ...
    <section className='max-w-7xl max-auto'>
      ...
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          Create imaginative and  visually stunnning images through DALL-E AI and share them with the community.
        </p>
      </div>

      <form className='mt-6 max-w-33xl' onClick={handleSubmite}>
